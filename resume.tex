...
~
	\smartdiagram[bubble diagram]{
        \color{white}\textbf{Web}\\\color{white}\textbf{Developer},
        \textbf{TypeScript},
        \textbf{JavaScript},
        \textbf{ReactJS},
        \textbf{Angular},
...
\librariesandframeworks{
    {\begin{itemize}[label={}]
        \item ReactJS \custombullet Angular \custombullet Node.js 
        \item Redux \custombullet ngrx \custombullet rxjs
        \item Webpack \custombullet Express
...
\certifications{
    \cvproject
        {\includegraphics[width=8mm]{img/gcp.png}}
        {Google Cloud Platform}
        {\href{https://www.credential.net/ejsoo32r}{\faKey}}
        {Dec 2017}
        {
        ...
        \\
    \cvproject
        {\includegraphics[width=10mm]{img/mongodb.png}}
        {MongoDB}
        {}
        {Sep 2015}
        {
